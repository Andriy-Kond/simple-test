...
// process.argv містить масив аргументів командного рядка (передані параметри під час запуску скрипта), а також шлях до Node.js на ПК і до проєкту (перші дві змінних)
// process.argv.slice(2) - поверне всі розділені пробілами параметри: ["param 1", "param 2", …]
